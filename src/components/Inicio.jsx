      ...
      <div className="hero-section">
        <div className="hero-wrapper">
          <div className="hero-content">
            ...
            <h1 className="hero-title">FERTEX</h1>
            <p className="hero-text">TaekwondoFertex - Escuela de artes marciales con 20 años de experiencia.</p>
            <p className="hero-text">Enseñanza y difusión del Taekwondo ITF, Muay Thai, Capoeira y Preparación física.</p>
          </div>
        </div>
      </div>
